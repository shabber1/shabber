...
public class CreateToDoPage {
	...
	public void datePicker(javaUtility jutil, webdriverutility driverUtil, String reqDate) {
		...
		int reqStartYear = (Integer) jutil.convertStringToAnyDataType(startDate[0], genericutilities.DataType.INT);
		...
		int currentYear = (Integer) jutil.convertStringToAnyDataType(str[1], genericutilities.DataType.INT);
		...
		while (currentYear < reqStartYear) {
			...
			currentYear = (Integer) jutil.convertStringToAnyDataType(str[1], genericutilities.DataType.INT);
		}
